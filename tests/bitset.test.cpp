...
boost::ut::suite bitset_test[](){
    ...
    "bitset::set()_increment_position_1"_test = [](){
        ...
        expect(that % 0x0000'0005 == test_set.set(2,true));
        expect(that % 0x0000'0009 == test_set.set(3,true));
    };
    ...
    "bitset::set()_increment_position_2"_test = [](){
        ...
        expect(that % 0x0000'0002 == test_set.set(1,true));
        expect(that % 0x0000'0006 == test_set.set(2,true));
        expect(that % 0x0000'000A == test_set.set(3,true));
    };
    ...
    "bitset::set()_set_no_change_3"_test = [](){
     ...
     "bitset::set()_increment_position_3"_test = [](){
        ...
        expect(that % 0x0000'000B == test_set.set(3,true));
    };
    ...
    "bitset::set()_increment_position_4"_test = [](){
        ...
        expect(that % 0x0000'0006 == test_set.set(1,true));
        expect(that % 0x0000'0004 == test_set.set(2,true));
        expect(that % 0x0000'000C == test_set.set(3,true));
    };
    ...
    "bitset::set()_set_no_change_5"_test = [](){
     ...
     "bitset::set()_increment_position_5"_test = [](){
        ...
        expect(that % 0x0000'0005 == test_set.set(2,true));
        expect(that % 0x0000'000D == test_set.set(3,true));
    };
    ...
    "bitset::set()_increment_position_10"_test = [](){
        ...
        expect(that % 0x0000'000A == test_set.set(1,true));
        expect(that % 0x0000'000E == test_set.set(2,true));
        expect(that % 0x0000'000A == test_set.set(3,true));
    };
    ...
    "bitset::set()_set_no_change_UH1"_test = [](){
     ...
     "bitset::set()_increment_position_UH1"_test = [](){
        ...
        expect(that % 0x0005'FFFF == test_set.set(18,true));
        expect(that % 0x0009'FFFF == test_set.set(19,true));
    };
